...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    /***/
    public List<String> getAllCountriesName(int name) {
    ...
    public CountryObject getCountryName(String name) {
        return _systemData.getCountry(name, getWritableDatabase());
    }
    ...
    /***/
    public List<String> getAllRegionsName(int name) {
