...
public class CountryListViewAdapter extends ArrayAdapter<VisitedRegionObject> {
    ...
    private void initializeVIewItems(int position, LinearLayout inventoryItemView) {
        ...
        TextView date = (TextView) inventoryItemView.findViewById(R.id.remove_textView_date);
        TextView continent = (TextView) inventoryItemView.findViewById(R.id.remove_textView_continents);
        TextView country = (TextView) inventoryItemView.findViewById(R.id.remove_textView_countries);
        TextView region = (TextView) inventoryItemView.findViewById(R.id.remove_textView_region);

        date.setText(item.getDate());

        RegionObject regionObject = item.getRegion(_db);
        country.setText(regionObject.getCountryId());
